 ...
 * @author TATIANA
 */
public class CVLogin extends javax.swing.JFrame {

    CVMostrarInformacion mosIn;
    public CVLogin() {
        mosIn= new CVMostrarInformacion();
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CVLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
